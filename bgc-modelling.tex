...
\column{0.5\linewidth}
\begin{itemize}
    \item After Jamart et al. (1977), who simulated the vertical profile of chlorophyll in idealised conditions, Fasham et al. (1990) were the first to explicitly include coupled physical and biogeochemical processes in a realistic context to simulate the North Atlantic sub-polar bloom. 
...
%-------------------------------------------------
\begin{frame}{Optional Exercise: different types of growth rates}
\begin{itemize}
\item {\small{}Phytoplankton growth follows an exponential phase, at least for a certain period of time until resources may become limiting or other factors control the Malthusian growth}{\small\par}
\item {\small{}The file }\texttt{\small{}flynn94.csv}{\small{} contains data from a batch experiment conducted by Flynn et al. (1994). The full table and the related units are available in file }\texttt{\small{}flynn94.pdf}{\small{}.
...
\item {\small{}Plot the data using a software of your choice and answer the following questions}{\small\par}
\begin{enumerate}
\item {\small{}Is the growth exponential? }{\small\par}
\item {\small{}Can you separate the growth curve into some phases?}{\small\par}
\item {\small{}How different is the growth expressed in cellular carbon from the one in cell number and chlorophyll?}{\small\par}
...
\item But we don't need to do the full derivation and write the computer code for each case
\item There exist several numerical methods based on \textbf{finite differences} and they are grouped under the name of \textbf{ODE solvers}. In the LV integration we will use the python ODE solver called \texttt{odeint} from the \texttt{scipy} module
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Light limitation}}
\[
P = P_{max} \left(1 - e^{-\alpha E/P_{max}}\right)
\]
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Marine biogeochemical models}}
\begin{itemize}
\item NPZD
\item ERSEM
\end{itemize}
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{ERSEM}}
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Chemical functional families}}
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Living functional groups}}
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Generic formalism}}
\[
\mathbf{X} = (C, N, P, Fe, Chl)
\]

\[
\frac{d\mathbf{X}}{dt} = \mathbf{F}(\mathbf{X}, E)
\]
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Biogeochemical Flux Model}}
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Modularity}}
\includegraphics[width=\linewidth]{figure_placeholder}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Linking physics and biology}}
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Phytoplankton blooms}}
\[
\int_0^{z_c} P(z)\,dz = \int_0^{z_c} R(z)\,dz
\]
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{OBGCM}}
\[
C = C(\mathbf{x}, t)
\]
\end{frame}
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Continuum hypothesis}}
\[
C(\mathbf{x}, t) \text{ continuous}
\]
\end{frame}

%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{Advection-Diffusion-Reaction}}
\[
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{ADR simplified}}
\[
\frac{\partial C}{\partial t}
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{1D models}}
\[
\frac{\partial C}{\partial t}
= \frac{\partial}{\partial z}
\left(K_z \frac{\partial C}{\partial z}\right) + R
\]
...
%------------------------------------------------
\begin{frame}{\textcolor{blue!70!black}{3D models}}
\[
\frac{\partial C}{\partial t}
