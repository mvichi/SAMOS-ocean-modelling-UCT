...
\begin{itemize}
\item We will write python code to plot the analytical solution of the NP model above to study the time evolution of phytoplankton and nutrient concentrations and analyse its dependency on the parameters.
